  ...
  render() {
    ...
    return (
      <Grid
        ...
        alignItems="center"
        justify="flex-start"
        style={{ minHeight: `${docHt() - 100}px`, paddingTop: "80px" }}
      >
        ...
        <Grid item container direction="column">
          <Grid item>
            <Typography
              variant="h2"
              style={{ ...Styles.colorWhite, ...Styles.padding5 }}
            >
              As promised, here is your secret home workout
            </Typography>
            <Grid
              item
              style={{ ...Styles.marginBottom, ...{ display: "inline-block" } }}
            >
              <Iframe
            ...
            <Typography
              variant="h1"
              style={{ ...Styles.colorPrimary, ...Styles.padding5 }}
            >
        ...
        <Grid
          item
          container
          style={{ ...Styles.centerTxt, ...Styles.padding5, ...Styles.blackBG }}
          justify="flex-start"
          alignItems="center"
          direction="column"
        >
          ...
          <Grid item>
            {!(emailSending || emailSent) && (
              <Button
                variant="contained"
                color="primary"
                style={{ ...Styles.marginBottom, ...{ width: "100%" } }}
            ...
            {!emailSending && emailSent && (
              ...
              >
                ...
                to check the packages, click on the button below
              </Typography>
            )}
          </Grid>
          <Grid item>
